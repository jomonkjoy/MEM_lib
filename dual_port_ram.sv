...
module dual_port_ram #(
    ...
    parameter USE_XILINX_PRIM = 0  // 0: behavioral, 1: Xilinx RAM32X1D primitives
) (
    // Write port
    input  logic                    wr_clk,
    input  logic                    wr_en,
    ...
    generate
        if (USE_XILINX_PRIM == 1 && DEPTH == 32) begin : xilinx_primitive
            // Xilinx RAM32X1D primitive implementation
            // Only supports 32-deep memories (5-bit address)
